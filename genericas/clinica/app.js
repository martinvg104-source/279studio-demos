/* Centro de Fisioterapia Ejemplo — demo autocontenida. Vanilla JS, sin dependencias. */
(function () {
  "use strict";
  ...
  function initBooking() {
    ...
    form.addEventListener("submit", function (ev) {
      ...
      confirmMsg.textContent = full ? "En lista de aviso" : "Cita agendada";
      confirm.querySelector(".stamp").textContent = full ? "EN AVISO" : "AGENDADA";
