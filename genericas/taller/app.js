...
(function () {
  ...
  function initBooking() {
    ...
    function selectSlot(slot) {
      ...
      btn.disabled = false;
      if (estimate) {
        estimate.textContent = slot.getAttribute("data-est") || "Estimación no disponible.";
        estimate.setAttribute("data-set", "true");
      }
    }
    ...
    form.addEventListener("submit", function (ev) {
      ...
      confirmMsg.textContent = full ? "Cita en el siguiente hueco" : "Cita confirmada";
      confirm.querySelector(".stamp").textContent = full ? "PENDIENTE" : "CONFIRMADA";
